...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.context.bot.send_message('👋 Бот для відмітки часу', reply_markup=InlineKeyboardMarkup(keyboard))
...
async def receive_checkin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.text:
        ...
        await update.message.context.bot.send_message(f'✅ Додано! Всього: {len(media["checkin"])}')
...
async def receive_checkout(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.text:
        ...
        await update.message.context.bot.send_message(f'✅ Додано! Всього: {len(media["checkout"])}')
    elif update.message.photo:
...
async def done(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.context.bot.send_message('✅ Збережено!')
    return ConversationHandler.END

async def cancel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.context.bot.send_message('❌ Скасовано')
    return ConversationHandler.END
